...
class DataTransformation:
    ...
    def initiate_data_transformation(self, train_path, test_path):
        ...
        try:
            #importing the ingested data (from artifacts folder)
            ...
            #calling data transfomer function and storing in a variable
            preprocessing_obj = self.get_data_transformer_object()

            #separating target and features in both train and test data
            target_column_name="math_score"

            input_feature_train_df=train_df.drop(columns=[target_column_name]) # X_train
            target_train_df=train_df[target_column_name]                       # y_train

            input_feature_test_df=test_df.drop(columns=[target_column_name])   # X_test
            target_test_df=test_df[target_column_name]                         # y_test

            logging.info("Applying preprocessing object on training dataframe and testing dataframe.")

            #This is where we apply data transformation
